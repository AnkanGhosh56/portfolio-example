...
const Services = () => {
    const services = [
        ...
        {id:2, name:'PROBLEM SOLVING', description:'I have solved over 200 problems at leetcode. I am a 5* coder at Hackerrank and have also solved over 100 questions at gfg. The programming languages that I know are Java and C++.', image:'images/android.png'},
